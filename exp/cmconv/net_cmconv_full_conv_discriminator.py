...
from .net_biggan_cmconv import D_arch, G_D
from BigGAN_PyTorch_1_lib.BigGAN import Generator
...
class Discriminator(nn.Module):
  ...
  def __init__(self, D_ch=64, D_wide=True, resolution=128,
    ...
    # fmt: off
    self.cmconv_out_channel              = get_attr_kwargs(cfg, 'cmconv_out_channel', **kwargs)
    ...
    self.cmconv = build_d2layer_v2(self.CMConv_cfg, style_dim=self.arch['out_channels'][-1],
                                   ...
                                   out_channels=self.cmconv_out_channel)
